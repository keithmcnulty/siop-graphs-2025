...
should transform your data and store it in a graph database.  
...
Note to self: Add illustrative image> showing employee nodes, department nodes, edges.
...
::: column
![Penguin bills art by Allison Horst](https://allisonhorst.github.io/palmerpenguins/reference/figures/culmen_depth.png){fig-alt="Penguin bill length is measured from start to tip of bill, whereas bill depth is measured from top of bill to bottom" fig-align="right"}
:::
:::::
