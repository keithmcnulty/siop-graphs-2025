...
## Put simply... {background-image="img/SIOP-lightgrey-background.png" background-size="cover"}
...
## Example technologies {background-image="img/SIOP-darkred-background.png" background-size="cover"}
...
## One page on each major use case {background-image="img/SIOP-darkred-background.png" background-size="cover"}
