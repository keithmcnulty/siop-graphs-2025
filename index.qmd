...
* Actively tracking and measuring leadership responsibilities such as mentorshop and sponsorship of more junior colleagues
* Identifying organizational skill/competency gaps
* Proactively suggesting new skills to declare or develop
...
## Other one-page themes  {background-image="img/SIOP-brightred-background.png" background-size="cover"}
...
## Pages on time use {background-image="img/SIOP-darkred-background.png" background-size="cover"}
